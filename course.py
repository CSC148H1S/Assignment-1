...
class Student:
    ...
    === Private Attributes ==
    _record: records student's answers to corresponding questions
    """

    id: int
    name: str
    _record: Dict[Question.id, Answer]
    ...
    def set_answer(self, question: Question, answer: Answer) -> None:
        ...
        """
        self._record[question.id] = answer
    ...
    def get_answer(self, question: Question) -> Optional[Answer]:
        ...
        """
        return self._record.get(question.id)
...
class Course:
    ...
    def all_answered(self, survey: Survey) -> bool:
        ...
        """
        for arg_student in self.students:
            for question in survey.get_questions():
                if not arg_student.has_answer(question):
                    return False
        return True
    ...
    def get_students(self) -> Tuple[Student, ...]:
        ...
        """
        student_list = sort_students(self.students, 'id')
