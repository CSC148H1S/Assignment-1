...
class MultipleChoiceQuestion(Question):
    ...
    def __str__(self) -> str:
        ...
        """
        if len(self.text) == 0:
            print("Question cannot be an empty string!")
        else:
            return f'Question: {self.text}. Possible answers: {self._options}'
...
class NumericQuestion(Question):
    ...
    def get_similarity(self, answer1: Answer, answer2: Answer) -> float:
        ...
        if answer1.content == answer2.content:
            ...
            max_ans = max(answer1, answer2)
            min_answer = min(answer1, answer2)
            return 1.0 - abs_difference / (max_ans - min_answer)
...
class YesNoQuestion(MultipleChoiceQuestion):
    ...
    def validate_answer(self, answer: Answer) -> bool:
        ...
        """
        if answer.content is True or False:
            return True
        else:
            return False
...
class CheckboxQuestion(MultipleChoiceQuestion):
    ...
    def __str__(self) -> str:
        ...
        You can choose the precise format of this string.
        """
        return f'Question: {self.text}. \nPossible answers: {self._options}'
    ...
    def get_similarity(self, answer1: Answer, answer2: Answer) -> float:
        ...
        count_1 = 0
        count_2 = 0
        for content_1 in answer1.content:
            count_1 += 1
            for content_2 in answer2.content:
                count_2 += 1
                if content_1 == content_2:
                    common += 1
        ratio = common / (count_1 + count_2)
        return ratio
...
class Answer:
    ...
    def is_valid(self, question: Question) -> bool:
        ...
        if question.validate_answer(self) is True:
            return True
        else:
            return False
...
class Survey:
    ...
    def __contains__(self, question: Question) -> bool:
        ...
        id as <question>.
        """
        if question.id in self.get_questions():
            return True
        else:
            return False
    ...
    def __str__(self) -> str:
        ...
        joint_questions = ', '.join(all_text)
        return f'Questions: {joint_questions}.'
