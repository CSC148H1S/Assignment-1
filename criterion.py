...
class InvalidAnswerError(Exception):
    ...
    def __str__(self) -> str:
        ...
        return 'Answer is invalid for the given question'
    ...
    def score_answers(self, question: Question, answers: List[Answer]) -> float:
        ...
        for answer1 in answers:
            for answer2 in answers:
                score += question.get_similarity(answer1, answer2)
        average = score / ((len(answers))**2)
        return average
...
class HeterogeneousCriterion(Criterion):
    ...
    def score_answers(self, question: Question, answers: List[Answer]) -> float:
        ...
        for answer1 in answers:
            for answer2 in answers:
                score += question.get_similarity(answer1, answer2)
        average = 1.0 - score / ((len(answers))**2)
        return average
